...
export async function generateCaptcha ( length: number, fontSize: number, backgroundColour: Colour, minContrastRatio: number ,pattern = 'A0', font = 'Courier New' ): Promise<Captcha> {
